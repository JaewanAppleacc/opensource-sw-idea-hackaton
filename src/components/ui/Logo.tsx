...
export function Logo({ className = '' }: LogoProps) {
  return (
    <span className={`inline-flex items-center gap-3 ${className}`}>
      <svg className="h-11 w-11 sm:h-13 sm:w-13" viewBox="0 0 32 32" aria-hidden="true" focusable="false">
      ...
      <span className="text-2xl font-bold tracking-tight text-ink-900 sm:text-[32px]">
        고용24
      </span>
    </span>
  )
