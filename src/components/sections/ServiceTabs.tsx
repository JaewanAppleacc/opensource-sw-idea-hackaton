  ...
  return (
    <Container className="relative -mt-2">
      <div
        ...
        className="mx-auto flex max-w-3xl flex-wrap justify-center gap-2 rounded-pill bg-surface-muted p-1.5 sm:flex-nowrap"
      >
        {serviceTabs.map((tab, index) => (
          <button
            ...
            className={`flex-1 whitespace-nowrap rounded-pill px-2.5 py-2.5 text-xs font-semibold transition sm:flex-initial sm:px-4 sm:text-sm ${
              activeTab === tab.id
