...
export function ImportantConditionsSelector({ selected, onChange }: ImportantConditionsSelectorProps) {
  ...
  return (
    <div className="rounded-card border border-ink-border bg-white p-4">
      <p className="text-sm font-bold text-ink-900">내가 중요하게 생각하는 조건을 선택해 주세요.</p>
      <p className="mt-0.5 text-xs text-ink-400">최대 {MAX_SELECTED}개까지 선택할 수 있어요. ({selected.length}/{MAX_SELECTED})</p>
